...
copying: # Step 2
	python services/copying_files.py --copy_from_dir preview/${class_name} --copy_to_dir mtcnn/training-data/raw/${class_name}
face-crop: # Step 3
	python mtcnn/code/align_dataset_mtcnn.py mtcnn/training-data/raw mtcnn/training-data/processed --image_size 160 --margin 32  --random_order --gpu_memory_fraction 0.25
face-recognition-train: # Step 4
	python mtcnn/code/classifier.py TRAIN mtcnn/training-data/processed mtcnn/models/20180402-114759.pb mtcnn/models/facemodel.pkl --batch_size 1000
